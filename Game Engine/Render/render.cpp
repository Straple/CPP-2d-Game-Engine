...
const point_t render_scale = 0.01; // ìàñøòàá ðåíäåðèíãà

point_t scale_factor = 0; // ìíîæèòåëü ìàñøòàáèðîâàíèÿ = render_state.height * render_scale
...
// ðèñóåò ïðÿìîóãîëüíèê â ïèêñåëÿõ ñ îáðàáîòêîé ãðàíèö
...
// çàðèñîâûâàåò âåñü ýêðàí ýòèì öâåòîì
...
// ðèñóåò òåêñòóðó
// x_cnt, y_cnt - êîëâî ñïðàéòîâ ïî êîîðäèíàòàì
...
// ðèñóåò ñïðàéò èç ëèñòà ñïðàéòîâ
// len_x - äëèíà ñïðàéòà ïî x
// sprite_count - èäåíòèôèêàòîð ñïðàéòà
...
// ðèñóåò âûðàâíåííûé òåêñò ïî öåíòðó
