...
public:
    ...
    // возвращает перпендикул€р из точки
    ...
    // возвращает параллельную пр€мую на рассто€нии dist
    ...
    // возвращает нормализованный вектор пр€мой умноженный на mult
    dot getVector(point_t mult = 1) const {
        return dot(-b, a)/*.normalize()*/ * mult;
    }

    // возвращает точку пересечени€ двух пр€мых
